...
export {TableTypeSwitchButtonsConfig} from './config/TableTypeSwitchButtonsConfig.ts';
...
export {Counter} from './instances/Counter.ts';
export {DocPage} from './instances/DocPage.ts';
export {Dot} from './instances/Dot.ts';
